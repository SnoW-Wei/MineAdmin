...
class PropertyWarmserviceApply extends MineModel
{
    ...
    protected array $fillable = [
        'id', 'user_id','user_name','user_phone','address', 'service_id', 'service_type','extra_type', 'apply_num', 'apply_date', 'pay_money', 'pay_wechat_no', 'status', 'created_at', 'updated_at', 'deleted_at'
    ];
    /**
