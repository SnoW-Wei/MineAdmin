...
use App\Park\Model\ParkPropertyServiceType;
 ...
 * 服务类型Mapper类
 */
class ParkPropertyServiceTypeMapper extends AbstractMapper
{
    /**
     * @var ParkPropertyServiceType
     */
    public $model;

    public function assignModel()
    {
        $this->model = ParkPropertyServiceType::class;
    }
